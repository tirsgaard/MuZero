...
MuZero_settings = {"temp_switch": 16,  # Number of turns before other temperature measure is used
...
training_settings = {"number_of_threads": 16,  # Number of games / threads to run on CPU
